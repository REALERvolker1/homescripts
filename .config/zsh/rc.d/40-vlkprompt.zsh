...
# vlkprompt, generated on 02/01/24 @ 11:52:52 PM by vlk using /home/vlk/random/homescripts/bin/promptgen.zsh
...
declare -A __vlkprompt_internal=( [right_prompt]= [log_content]= [log_end_color]= [host_content]= [host_end]= [prev_pwd]= [pwd]= [pwd_writable]= [pwd_git]= [old_time]=0 [timer_str]= [venv_str]= [conda_str]= )
...
precmd_functions+=( '__vlkprompt::precmd::timer' '__vlkprompt::precmd::cwd' '__vlkprompt::precmd::venv')
