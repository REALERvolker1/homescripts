...
PROMPT="%k%f%b%u%s\$VLKPROMPT_CONDENV_STR%(130V..
...
__vlkprompt_precmd() {
    ...
    if [[ -n ${CONDA_DEFAULT_ENV:-} ]]; then
        VLKPROMPT_CONDENV_STR="conda ($CONDA_DEFAULT_ENV)"
    else
        VLKPROMPT_CONDENV_STR=''
    fi
...
precmd_functions+=('__vlkprompt_precmd' '__vlkprompt_sudo_cmd')
