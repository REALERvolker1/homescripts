...
-- One rule per line makes individual applications easy to enable or disable.
-- Rule order follows production; later matching effects take precedence.
multicls(
    { immediate = true },
    {
