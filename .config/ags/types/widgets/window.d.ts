...
export default class AgsWindow extends AgsWindow_base {
    constructor({ anchor, exclusive, exclusivity, focusable, layer, margins, monitor, popup, visible, ...params }?: WindowProps);
    get monitor(): Gdk.Monitor;
    set monitor(monitor: number);
    get exclusive(): boolean | undefined;
