...
declare const aligns: readonly ["fill", "start", "end", "center", "baseline"];
...
export type Connection<Self> = [GObject.Object, (self: Self, ...args: unknown[]) => unknown, string?] | [string, (self: Self, ...args: unknown[]) => unknown] | [number, (self: Self, ...args: unknown[]) => unknown];
export type Bind = [
    prop: string,
    obj: GObject.Object,
    objProp?: string,
