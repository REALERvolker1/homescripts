...
declare const AgsIcon_base: {
    new (...args: any[]): {
        ...
        render_icon(stock_id: string | null, size: number, detail: string | null): GdkPixbuf.Pixbuf | null;
        render_icon_pixbuf(stock_id: string | null, size: number): GdkPixbuf.Pixbuf | null;
        ...
        emit(sigName: "draw", cr: cairo.Context, ...args: any[]): void;
...
export default class AgsIcon extends AgsIcon_base {
