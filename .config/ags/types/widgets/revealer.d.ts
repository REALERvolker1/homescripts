...
declare const transitions: readonly ["none", "crossfade", "slide_right", "slide_left", "slide_up", "slide_down"];
type Transition = typeof transitions[number];
export interface RevealerProps extends BaseProps<AgsRevealer>, Gtk.Revealer.ConstructorProperties {
    transition?: Transition;
}
declare const AgsRevealer_base: {
    new (...args: any[]): {
...
export default class AgsRevealer extends AgsRevealer_base {
