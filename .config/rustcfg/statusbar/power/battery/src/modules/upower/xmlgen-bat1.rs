...
//! Source: `Interface '/org/freedesktop/UPower/devices/battery_BAT1' from service 'org.freedesktop.UPower' on system bus`.
//!
...
#[dbus_proxy(
    ...
    default_path = "/org/freedesktop/UPower/devices/battery_BAT1"
)]
trait Device {
    /// GetHistory method
    fn get_history(
