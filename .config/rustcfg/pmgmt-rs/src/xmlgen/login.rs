...
//! Source: `Interface '/org/freedesktop/login1/session/auto' from service 'org.freedesktop.login1' on system bus`.
//!
...
trait Session {
    ...
    fn set_tty(&self, tty_fd: zbus::zvariant::Fd) -> zbus::Result<()>;
    ...
    /// ResumeDevice signal
    #[dbus_proxy(signal)]
    fn resume_device(&self, major: u32, minor: u32, fd: zbus::zvariant::Fd) -> zbus::Result<()>;
