...
function update_workspaces(btn, id) {
    ...
    return Widget.EventBox({
        ...
        connections: [
            [
                ...
                (btn) => btn.toggleClassName("workspace_button_active", Hyprland.active.workspace.id === id),
            ],
        ],
...
const workspace_thing = Widget.Box({
    ...
    children: Array.from({ length: 10 }, (_, i) => i + 1).map((i) => workspace_button(i)),
    // connections: [
    //     [
    //         Hyprland,
    //         (box) => {
