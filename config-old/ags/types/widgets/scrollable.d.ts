...
export interface ScrollableProps extends BaseProps<AgsScrollable>, Gtk.ScrolledWindow.ConstructorProperties {
    hscroll?: Policy;
    vscroll?: Policy;
}
declare const AgsScrollable_base: {
    new (...args: any[]): {
...
export default class AgsScrollable extends AgsScrollable_base {
