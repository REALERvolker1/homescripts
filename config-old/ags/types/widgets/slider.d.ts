...
declare const positions: readonly ["left", "right", "top", "bottom"];
...
export default class AgsSlider extends AgsSlider_base {
    constructor({ value, min, max, step, marks, ...rest }?: SliderProps);
    get on_change(): EventHandler;
