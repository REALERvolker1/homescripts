...
export interface MenuProps extends BaseProps<AgsMenu>, Gtk.Menu.ConstructorProperties {
    children?: Gtk.Widget[];
    on_popup?: (self: AgsMenu, flipped_rect: any | null, final_rect: any | null, flipped_x: boolean, flipped_y: boolean) => void | unknown;
    on_move_scroll?: (self: AgsMenu, scroll_type: Gtk.ScrollType) => void | unknown;
}
declare const AgsMenu_base: {
    new (...args: any[]): {
        ...
        activate(): boolean;
        add_accelerator(accel_signal: string | null, accel_group: Gtk.AccelGroup, accel_key: number, accel_mods: import("@girs/gdk-3.0").Gdk.ModifierType, accel_flags: Gtk.AccelFlags): void;
        ...
        override_symbolic_color(name: string | null, color: import("@girs/gdk-3.0").Gdk.RGBA | null): void;
...
export declare class AgsMenu extends AgsMenu_base {
    constructor(props?: MenuProps);
    get on_popup(): MenuProps['on_popup'];
    set on_popup(callback: MenuProps['on_popup']);
    get on_move_scroll(): MenuProps['on_move_scroll'];
...
declare const AgsMenuItem_base: {
    new (...args: any[]): {
        _init(config?: Gtk.Widget.ConstructorProperties | undefined): void;
        hovered: boolean;
        _destroyed: boolean;
...
export declare class AgsMenuItem extends AgsMenuItem_base {
    constructor(props?: MenuItemProps);
    get on_activate(): MenuItemProps['on_activate'];
    set on_activate(callback: MenuItemProps['on_activate']);
    get on_select(): EventHandler;
    set on_select(callback: EventHandler);
    get on_deselect(): EventHandler;
