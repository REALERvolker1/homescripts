...
export interface CircularProgressProps extends BaseProps<AgsCircularProgress>, Gtk.Bin.ConstructorProperties {
    rounded?: boolean;
    value?: number;
    inverted?: boolean;
    start_at?: number;
}
declare const AgsCircularProgress_base: {
    new (...args: any[]): {
...
export default class AgsCircularProgress extends AgsCircularProgress_base {
